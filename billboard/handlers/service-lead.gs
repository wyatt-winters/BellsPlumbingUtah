 ...
 * Deploy once at script.google.com → Web app (Anyone) → paste /exec URL into
 * js/lead-form.js (FORM_ENDPOINT).
 *
 * Backward compatible with snow-melt consultation submissions.
 */
